...
def print_help():
    print(
        "DotFiles Updater Help:\n\n"
        "-h or --help: This page.\n"
        "-d or --installdir: Sets the installation directory.\n"
        "-m or --modules: The modules to be updated. (from 'installers' dir)\n"
...
def main():
    ...
    for module in modules:
        try:
            install_module(module, install_dir, available_modules, install_dependencies=False)
